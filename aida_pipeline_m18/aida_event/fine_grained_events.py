...
# default mapping
newtype_mapping_backup = load_mapping('rules/mapping_backup.txt')
# if here, directly mapping
newtype_mapping_sure = load_mapping('rules/mapping.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trans_file', type=str,
                        help='trans_file')
    parser.add_argument('--filler_coarse', type=str,
                        help='filler_coarse')
    parser.add_argument('--entity_finegrain_aida', type=str,
    ...
    type_dict_path = 'rules/type_dict.txt'
    trigger_dict_path = 'rules/trigger_dict_clean_v2.txt'
