...
relation_result_dir=data/ut_texas/relation   # final cs output file path
relation_cs_name=en.rel.cs # final cs output for relation
event_dep_dir=data/ut_texas/dep # dependency parser outout
event_tmp_tdf_dir=data/ut_texas/tdf # text data feeder folder for events
event_no_format_dir=data/ut_texas/event_no_format #unformatted event output
event_result_dir=data/ut_texas/event #event output folder
final_output_file=data/ut_texas/en_full.cs # final output of everything
